...
<div style="margin-left: 50px; display:flex; flex-direction:column;" class="form-group row">
<form  action="{{route('add.foods.for.extra',$extraid)}}" method="POST">
  @csrf
  <label> هل تريد تحديد منتجات مباشرة لهذه الاضافة الجديدة <strong>{{$extraname}}</strong>  </label>
    <br>
